...
public class CustomerMain extends javax.swing.JFrame {
    ...
    public CustomerMain(Customer currentUser) {
        ...
        tfOrderFullname.setText(currentUser.getUserFullName());
        tfOrderNoTelp.setText(currentUser.getUserPhoneNumber());
        tfOrderAlamat.setText(currentUser.getUserAddress());
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/buburgowes/assets/images/we.jpg"))); // NOI18N
        ...
        jPanelAboutUsLayout.setVerticalGroup(
            jPanelAboutUsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelAboutUsLayout.createSequentialGroup()
                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 473, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        // pop up message if the user whant to order


        // if the user click yes
        // then the order will be saved to the database
        if (jumlahBubur1 == 0 && jumlahBubur2 == 0 && jumlahBubur3 == 0) {
            JOptionPane.showMessageDialog(this, "Anda belum memesan apapun");
        } else if (nama.isEmpty() || noTelp.isEmpty() || alamat.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Mohon lengkapi data diri Anda");
        } else {
            int dialogResult = JOptionPane.showConfirmDialog(this, "Apakah anda yakin ingin memesan?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.YES_OPTION) {
                // save to database
                buburGowes.executeOrder(this, alamat, jumlahBubur1, jumlahBubur2, jumlahBubur3);
            }
        }
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (row != -1) {
            if (JOptionPane.showConfirmDialog(this, "Apakah Anda yakin ingin menghapus pesanan ini?", "Konfirmasi", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, "Pilih data yang akan dihapus", "Error", 3);
        }
